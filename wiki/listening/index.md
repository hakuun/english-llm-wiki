...
追踪听力材料、transcripts、跟读和复述练习。

## 核心页面

- [[listening/transcript-notes]] — 所有听力材料列表、学习方法和进度记录
- [[listening/shadowing-and-retelling]] — 跟读和复述的详细方法、发音提示、BBC 材料推荐
...
> CEFR B2 听力要求：能理解社交、职业或学术场景中标准语言的录音材料，能识别说话人的观点和态度，以及信息内容。（CEFR Companion Volume, 2020, p.52）

详见 `[[standards/cefr-b2-target]]` 和 `[[assessments/b2-can-do-checklist]]` 中的听力检查项。
...
在目前以阅读为主的 30 分钟 daily routine 中，建议：

- **每周 2 天**使用听力材料（其他 3-5 天继续阅读）
- 每份听力材料用 **2 天循环**完成（Day 1 听+读+词汇，Day 2 跟读+复述）
- 听力日仍保持 review-first 和 guided output 的原则
